...
function Dishes() {
  return (
    ...
    <div className='space-y-20 py-32'>
      ...
      <h1 className='text-6xl font-bolder font-thin text-black'>POPULAR DISHES</h1>
      <p className='text-base tracking-widest  text-black'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga, iusto dolorem! Voluptatibus ipsum nam mollitia architecto. Soluta pariatur eius et recusandae veritatis. Quasi, et molestias!</p>
      </div>
      <div className="container grid xl:grid-cols-4  lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1  gap-10">
        {
          data[0].dishes.map(element => (
            <div className='space-y-5 relative' key={element.id}>
              ...
              <h3 className='text-black text-2xl font-bold text-center'>{element.title}</h3>
